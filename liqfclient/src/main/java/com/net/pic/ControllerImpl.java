...
public class ControllerImpl implements Controller {
    ...
    public List<File> fetchImages(String pageUrl, String imgSaveDir) throws MalformedURLException,
        ...
        for (FileBean fileBean : fileBeanList) { // 开threadNum个线程
            String newFileName = fileBean.getFileName().substring(
                fileBean.getFileName().lastIndexOf("/") + 1, fileBean.getFileName().length());
            FutureTask<Object> ft = new FutureTask<Object>(new DownPicTask(fileBean.getFileName(),
        ...
        for (FutureTask<Object> tempFt : listObj) {
            ...
            try {
                ...
                tempMap = ((HashMap<String, Boolean>) tempFt.get(10, TimeUnit.SECONDS));
                ...
                for (Map.Entry<String, Boolean> temp : tempMap.entrySet()) {
                    ...
                    if (fileMap.containsKey(picUrlStr) && temp.getValue().booleanValue() == true) {
        ...
        if (messageArea != null) {
            messageArea.setText(messageArea.getText() + "/n" + " 任务完成，共下载" + i + "个图片!");
        }
    ...
    public static void main(String[] args) {
        ...
        String testUrl5 = siteUrl + "forum-890-" + pageNum + ".html";
        ...
        try {
            ...
            controller.fetchImages(testUrl5, fileDir);
